...
class CustomerForm(UserCreationForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'last_name': forms.fields.TextInput(attrs={'placeholder': 'Enter your first name', 'class': 'form-control'}),
            'username': forms.fields.TextInput(
                attrs={'placeholder': 'Enter your last name', 'class': 'form-control'}),
            'password1': forms.fields.TextInput(
                attrs={'placeholder': 'Enter your password name', 'class': 'form-control'}),
            'password2': forms.fields.TextInput(
                attrs={'placeholder': 'Enter your confirm password like password', 'class': 'form-control'}),
